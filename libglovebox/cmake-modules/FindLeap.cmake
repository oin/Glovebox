...
# Add user-provided environment variable
IF(DEFINED ENV{LEAPSDKPATH})
    list(APPEND LEAP_INCLUDE_SEARCH_DIRS $ENV{LEAPSDKPATH}/include)
    list(APPEND LEAP_INC_DIR_SUFFIXES $ENV{LEAPSDKPATH}/lib)
ENDIF()
